...
df = df[df.kl_dist <= 310]
print("Size of original data:", len(df))



df = downsample(df, 10000)
...
# # SVM training
# clf = SVC(kernel="poly", C=0.001, gamma=0.001, degree=3)
# clf = SVC(kernel="poly", C=0.01, gamma=0.001, degree=3)

# print("Training classifier...")
# model = clf.fit(X_train, y_train)

# # save model to disk
# pickle.dump(model, open("SVM_training_predictions/svm.sav", 'wb'))
...
check_params = {
    'SVM__kernel' : ['poly'],
    'SVM__degree' : [3],
    'SVM__C': [1, 0.1, 0.01, 0.001, 0.0001],
    'SVM__gamma': [1, 0.1, 0.01, 0.001, 0.0001]
}
# poly degree 3, C=0.01, gamma=0.001
