...
events = []
for file in glob.glob(inputDir + "event_*.gpickle"):
...
# with open(outputDir + str(num_events) + '_events_training_data.csv', 'w+', encoding='UTF8', newline='\n') as f:
with open(outputDir + str(num_events) + '_events_training_data.csv', 'w+', encoding='UTF8') as f:
    writer = csv.writer(f)
